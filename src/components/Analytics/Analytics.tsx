    ...
    <div className="w-full bg-white py-16 px-4">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center gap-3">
          ...
          <button className="bg-black text-accent hover:bg-accent hover:text-black w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 transition-all duration-300">
            Get Started
          </button>
        </div>
      </div>
